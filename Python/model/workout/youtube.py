...
# DEVELOPER_KEY = "AIzaSyAuaRUIoiq-fKRKLpOej1YfC7H1CES84lU"
...
def youtube(keywords):
    ...
    for query in keywords:
        ...
        for search_result in search_response['items']:
            ...
            video_stats.update({
                ...
                'url': f'https://www.youtube.com/watch?v={videoid}'  # YouTube 비디오의 URL을 생성
            })
            # 최종 결과 데이터에 추가
    ...
    df = df.groupby('key').apply(lambda x: x.sort_values('viewCount', ascending=False).head(5)).reset_index(drop=True)
